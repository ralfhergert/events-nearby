...
export class Languages {
	...
	se= 'Northern Sami';
	sg= 'Sango';
	sh= 'Serbo-Croatian'; // sr, hr, bs are preferred for most modern uses
	...
	bxd= 'Pela';
	bxe= 'Birale';
	bxf= 'Bilur/Minigir'; // see also vmg
	bxg= 'Bangala';
	bxh= 'Buhutu';
	bxi= 'Pirlatapa';
	bxj= 'Bayungu';
	...
	kgx= 'Kamaru';
	kgy= 'Kyerung';
	kha= 'Khasi'; // as of 2008-04-21 this subtag does not include Lyngngam; see lyg
	khb= 'Lü';
	...
	nmd= 'Ndumu';
	nme= 'Mzieme Naga';
	nmf= 'Tangkhul Naga (India)'; // see ntx
	nmg= 'Kwasio';
	nmh= 'Monsang Naga';
	nmi= 'Nyam';
	...
	ntu= 'Natügu';
	ntw= 'Nottoway';
	ntx= 'Tangkhul Naga (Myanmar)'; // see nmf
	nty= 'Mantsi';
	ntz= 'Natanzi';
	nua= 'Yuanga';
	...
	pnw= 'Panytyima';
	pnx= 'Phong-Kniang';
	pny= 'Pinyin'; // a Niger-Congo language spoken in Cameroon; not to be confused	with the Pinyin romanization systems used for Chinese and Tibetan
